...
const getTotalUniversities = async (req, res) => {
    try {
        ...
        res.json({ message: 'Total universities retrieved successfully', count });
    } catch (error) {
        console.error('Error retrieving total universities:', error);
        res.status(500).json({ message: 'Error retrieving total universities', error: error.message });
    }
};
...
const getTotalSpocs = async (req, res) => {
    try {
        const count = await Spoc.countDocuments();
        res.json({ message: 'Total SPOCs retrieved successfully', count });
    } catch (error) {
        console.error('Error retrieving total SPOCs:', error);
        res.status(500).json({ message: 'Error retrieving total SPOCs', error: error.message });
    }
};
...
const getTotalCourses = async (req, res) => {
    try {
        ...
        res.json({ message: 'Total courses retrieved successfully', count });
    } catch (error) {
        console.error('Error retrieving total courses:', error);
        res.status(500).json({ message: 'Error retrieving total courses', error: error.message });
    }
};
